<?php
session_start();
if (!isset($_SESSION['login_comfram'])) {
...
print_r($after_assoc_log);

// massages 
$message_set = "SELECT * FROM massages order by id desc";
$message_res_mass = mysqli_query($db_connection, $message_set);
// massage count
$message_unread = "SELECT COUNT(*) as total FROM massages WHERE status=0";
$message_res_unread = mysqli_query($db_connection, $message_unread);
$after_assoc_unread = mysqli_fetch_assoc($message_res_unread);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="/fromCreate/dashbord_asset/images/favicon.png">
	<link rel="stylesheet" href="/fromCreate/dashbord_asset/vendor/chartist/css/chartist.min.css">
	<link href="/fromCreate/dashbord_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/fromCreate/dashbord_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
	<link href="/fromCreate/dashbord_asset/css/style.css" rel="stylesheet">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="index.html" class="brand-logo">
				<img class="logo-abbr" src="/fromCreate/dashbord_asset/images/logo.png" alt="">
				<img class="logo-compact" src="/fromCreate/dashbord_asset/images/logo-text.png" alt="">
				<img class="brand-title" src="/fromCreate/dashbord_asset/images/logo-text.png" alt="">
			</a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/fromCreate/dashbord_asset/images/avatar/1.jpg" class="rounded-circle user_img" alt="" />
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/fromCreate/dashbord_asset/images/avatar/2.jpg" class="rounded-circle user_img" alt="" />
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/fromCreate/dashbord_asset/images/avatar/3.jpg" class="rounded-circle user_img" alt="" />
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/fromCreate/dashbord_asset/images/avatar/4.jpg" class="rounded-circle user_img" alt="" />
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/fromCreate/dashbord_asset/images/avatar/5.jpg" class="rounded-circle user_img" alt="" />
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
						...
						<div class="card chat dz-chat-history-box d-none">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="/fromCreate/dashbord_asset/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="/fromCreate/dashbord_asset/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="" />
									</div>
									<div class="msg_cotainer">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
								<a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css  text-center text-white bg-red"><?= $after_assoc_unread['total'] ?></div>
								</a>
								<div class="dropdown-menu rounded dropdown-menu-right">
									<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											<?php foreach ($message_res_mass as $massages) { ?>
												<li>
													<div class="timeline-panel">
														<a href="../massage/view.php?id=<?= $massages['id'] ?>">
															<div style=" display:block" class="media-body <?= $massages['status'] == 1 ? '' : 'bg-dark p-3' ?>">
																<div class="text-white" style="width: 25px; height: 25px; text-align:center; line-height:25px; background:black; border-radius:50%; font-size: 25px;"><?= substr($massages['name'], 0, 1) ?></div>
																<h6 class="mb-1"> <strong class="<?= $massages['status'] == 1 ? '' : 'text-white' ?>"><?= $massages['name'] ?></strong> <span class="<?= $massages['status'] == 1 ? '' : 'text-white' ?>">Send you Message</span></h6>
																<small class="d-block <?= $massages['status'] == 1 ? '' : 'text-white' ?>"><?= date('d-m-y, h:i:s a', strtotime($massages['created_at'])) ?></small>
															</div>
														</a>
													</div>
												</li>
									...
									<a class="all-notification" href="/fromCreate/massage/massage.php">See all Messages <i class="ti-arrow-right"></i></a>
								</div>
							</li>
							<li class="nav-item dropdown notification_dropdown">
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									<?php if ($after_assoc_log['photo'] == null) { ?>
										<img src="/fromCreate/dashbord_asset/images/profile/17.jpg" width="20" alt="" />
									<?php } else { ?>
										<img src="/fromCreate/uploads/users/<?= $after_assoc_log['photo'] ?>" width="20" alt="" />
									<?php } ?>

									<div class="header-info">
										<span class="text-black"><strong><?= ($after_assoc_log['fast_name']) ?></strong></span>
										<?php if ($after_assoc_log['rule'] != null) { ?>
											<p class="fs-12 mb-0">
												<?php if ($after_assoc_log['rule'] == 1) {
													echo 'Super Admin';
												} else if ($after_assoc_log['rule'] == 2) {
													echo 'Admin';
												} else if ($after_assoc_log['rule'] == 3) {
													echo 'Moderator';
												} else if ($after_assoc_log['rule'] == 4) {
													echo 'Editor';
												}
												?>
											</p>
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a href="/fromCreate/users/profile.php" class="dropdown-item ai-icon">
									...
									<a href="/fromCreate/logout.php" class="dropdown-item ai-icon">
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon" href="/fromCreate/dashbord.php" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
					</li>
					<?php if ($after_assoc_log['rule'] == 1) { ?>
						<li><a class="has-arrow ai-icon" href="/fromCreate/users/users.php">
								<i class="flaticon-381-television"></i>
								<span class="nav-text">Users</span>
							</a>
						</li>
					<?php } ?>
					<li><a class="has-arrow ai-icon" href="/fromCreate/logo/logo.php">
							<i class="flaticon-381-controls-3"></i>
							<span class="nav-text">Logo</span>
						</a>
					</li>
					<li><a class="has-arrow ai-icon" href="/fromCreate/about/about.php">
							<i class="flaticon-381-internet"></i>
							<span class="nav-text">About</span>
						</a>
					</li>
					<li><a class="has-arrow ai-icon" href="/fromCreate/skill/skill.php">
							<i class="flaticon-381-heart"></i>
							<span class="nav-text">Skill</span>
						</a>
					</li>
					<li><a href="/fromCreate/service/service.php" class="ai-icon">
							<i class="flaticon-381-settings-2"></i>
							<span class="nav-text">Services</span>
						</a>
					</li>

					<li><a class="has-arrow ai-icon" href="/fromCreate/protfolio/protfolio.php">
							<i class="flaticon-381-notepad"></i>
							<span class="nav-text">Protfolio</span>
						</a>
					</li>
					<li><a class="has-arrow ai-icon" href="/fromCreate/feedback/feedback.php">
							<i class="flaticon-381-network"></i>
							<span class="nav-text">Testimonial</span>
						</a>
					</li>
					<li><a class="has-arrow ai-icon" href="/fromCreate/massage/massage.php">
